    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="举报标题" prop="jubaofankuiName">
                       <el-input v-model="ruleForm.jubaofankuiName"
                                 placeholder="举报标题" clearable  :readonly="ro.jubaofankuiName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="举报标题" prop="jubaofankuiName">
                           <el-input v-model="ruleForm.jubaofankuiName"
                                     placeholder="举报标题" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="举报用户" prop="yonghuName">
                       <el-input v-model="ruleForm.yonghuName"
                                 placeholder="举报用户" clearable  :readonly="ro.yonghuName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="举报用户" prop="yonghuName">
                           <el-input v-model="ruleForm.yonghuName"
                                     placeholder="举报用户" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="举报内容" prop="jubaofankuiText">
                        <el-input type="textarea"  :readonly="ro.jubaofankuiText" v-model="ruleForm.jubaofankuiText" placeholder="举报内容"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.jubaofankuiText" label="举报内容" prop="jubaofankuiText">
                            <span v-html="ruleForm.jubaofankuiText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yonghuId: false,
                    jubaofankuiName: false,
                    yonghuName: false,
                    jubaofankuiText: false,
                    insertTime: false,
                },
                ruleForm: {
                    yonghuId: '',
                ...
                rules: {
                   ...
                   yonghuName: [
                              { required: true, message: '举报用户不能为空', trigger: 'blur' },
                          ],
                   jubaofankuiText: [
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`jubaofankui/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.jubaofankuiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
