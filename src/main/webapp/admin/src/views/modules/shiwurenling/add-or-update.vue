        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='shiwuzhaoling'">
                    <el-form-item class="select" v-if="type!='info'"  label="失物招领" prop="shiwuzhaolingId">
                        <el-select v-model="ruleForm.shiwuzhaolingId" :disabled="ro.shiwuzhaolingId" filterable placeholder="请选择失物招领" @change="shiwuzhaolingChange">
                            <el-option
                ...
                <el-col :span="24" v-if="sessionTable !='shiwuzhaoling' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.shiwuzhaolingPhoto" label="物品图片" prop="shiwuzhaolingPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (shiwuzhaolingForm.shiwuzhaolingPhoto || '').split(',')" :src="item" width="100" height="100">
                    </el-form-item>
                    <div v-else>
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="认领凭证" prop="shiwurenlingText">
                        <el-input type="textarea"  :readonly="ro.shiwurenlingText" v-model="ruleForm.shiwurenlingText" placeholder="认领凭证"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.shiwurenlingText" label="认领凭证" prop="shiwurenlingText">
                            <span v-html="ruleForm.shiwurenlingText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.shiwurenlingYesnoTypes" label="审核" prop="shiwurenlingYesnoTypes">
                        <el-input v-model="ruleForm.shiwurenlingYesnoValue" placeholder="审核" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.shiwurenlingYesnoText" label="详情" prop="shiwurenlingYesnoText">
                        <span v-html="ruleForm.shiwurenlingYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    shiwurenlingYesnoTypes: false,
                    shiwurenlingYesnoText: false,
                    insertTime: false,
                },
                ruleForm: {
                    shiwuzhaolingId: '',
                    yonghuId: '',
                    shiwurenlingText: '',
                    shiwurenlingYesnoTypes: '',
                    shiwurenlingYesnoText: '',
                    insertTime: '',
                },
                shiwurenlingYesnoTypesOptions : [],
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=shiwurenling_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.shiwurenlingYesnoTypesOptions = data.data.list;
                    }
                });
